...
export const metadata: Metadata = {
  title: 'Runway Prep — The Recruiting Game Starts Here',
  description:
    'Maximize your exposure. Reach coaches. Get offers. Runway Prep gives high school football athletes the tools to compete in the recruiting game.',
}
      ...
      <section className="relative flex min-h-screen items-center justify-center px-6 text-center">
        ...
        <div className="relative z-10 mx-auto max-w-4xl -mt-[29px] sm:mt-0">
          ...
          <h1 className="mb-6 font-display text-5xl font-black uppercase leading-none tracking-tight md:text-7xl">
            ...
            <span style={{ color: '#cc2222' }}>Starts Here</span>
          </h1>
          ...
          <p className="mx-auto mb-10 max-w-2xl text-xl leading-relaxed text-white/80 md:text-2xl">
            ...
            Runway Prep gives you every tool you need to reach coaches, find the right programs, and get offers.
          </p>
          ...
          <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
            <Link
              ...
              style={{
                background: 'linear-gradient(135deg, #cc2222 0%, #8a0f0f 100%)',
                boxShadow: '0 4px 24px rgba(204,34,34,0.45)',
              }}
            >
              Get Started — $10/mo
            </Link>
          ...
          <p className="mt-4 text-sm text-white/35">
            $90/year — save 25% &nbsp;·&nbsp; Cancel anytime
          </p>
        </div>
        ...
        <div className="relative z-10 mx-auto max-w-5xl">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            ...
            <PillarCard
              number="03"
              title="Exposure"
              description="This is where we live. Connect with coaches, manage your outreach, build your recruiting presence - all powered by Runway Prep."
              ours={true}
            />
          </div>
        </div>
      ...
      >
        ...
        <div className="relative z-10 mx-auto max-w-3xl text-center">
          ...
          >
            ...
            <span style={{ color: '#cc2222' }}>They prepared smarter</span> — and they started earlier.&quot;
          </h2>
          <p className="mx-auto max-w-2xl text-lg leading-relaxed text-gray-500">
            ...
            is its own competition — and most athletes don&apos;t have a system for it. Runway Prep
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            <div className="rounded-2xl border border-white/10 bg-white/5 p-8">
              ...
              <div className="mb-6 flex items-end gap-2">
                <span className="font-display text-6xl font-black text-white">$10</span>
            ...
            >
              ...
              <div className="mb-1 flex items-end gap-2">
                <span className="font-display text-6xl font-black text-white">$90</span>
        ...
        <div className="relative z-10 mx-auto max-w-2xl">
          <div className="mb-6 flex justify-center">
            <div className="relative h-20 w-20">
              <Image src="/logo.png" alt="Runway Prep" fill className="object-contain" />
            </div>
          </div>
          <h2 className="mb-4 font-display text-4xl font-black uppercase tracking-tight text-[#0a1525] md:text-6xl">
            Ready to <span style={{ color: '#cc2222' }}>Take Off?</span>
          </h2>
          ...
          <Link
            ...
            style={{
              background: 'linear-gradient(135deg, #cc2222 0%, #8a0f0f 100%)',
              boxShadow: '0 4px 32px rgba(204,34,34,0.35)',
            }}
          >
            Get Started
          </Link>
          <p className="mt-4 text-sm text-gray-400">$10/month · $90/year · Cancel anytime</p>
        </div>
      </section>
...
function PillarCard({ number, title, description, ours }: { number: string; title: string; description: string; ours: boolean }) {
  return (
    <div
      className={`rounded-2xl p-8 ${ours ? 'text-white' : 'border border-gray-100 bg-gray-50 text-[#0a1525]'}`}
      style={ours ? { background: 'linear-gradient(135deg, #1a3a6e 0%, #0d2040 100%)', boxShadow: '0 8px 32px rgba(26,58,110,0.25)' } : undefined}
    >
      <div className="mb-4 font-display text-4xl font-black tracking-tight" style={{ color: ours ? 'rgba(255,255,255,0.2)' : '#e5e7eb' }}>
        {number}
      </div>
      <h3 className="mb-3 font-display text-xl font-black uppercase tracking-tight" style={{ color: ours ? '#ffffff' : '#0a1525' }}>
        {title}
        {ours && (
          <span className="ml-2 rounded-full px-2 py-0.5 text-[10px] font-bold uppercase tracking-wider" style={{ background: '#cc2222', color: 'white' }}>
            That&apos;s Us
          </span>
        )}
      </h3>
      <p className="text-sm leading-relaxed" style={{ color: ours ? 'rgba(255,255,255,0.65)' : '#6b7280' }}>
        {description}
      </p>
    </div>
  )
...
function FeatureCard({ icon, title, description }: { icon: string; title: string; description: string }) {
  return (
    <div className="rounded-2xl border border-white/8 p-7 transition hover:border-white/15" style={{ background: 'rgba(255,255,255,0.04)' }}>
      <span className="mb-4 block text-3xl">{icon}</span>
      <h3 className="mb-2 font-display text-lg font-bold uppercase tracking-tight text-white">{title}</h3>
