...
export default function RegisterPage() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    // Create user server-side (skips email confirmation)
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl p-7 border border-white">
          ...
          <p className="text-sm text-gray-500 mb-5">Your recruiting takes off today.</p>
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 py-3 px-4 border-2 rounded-xl bg-white hover:bg-gray-50 transition disabled:opacity-50 shadow-sm mb-4"
