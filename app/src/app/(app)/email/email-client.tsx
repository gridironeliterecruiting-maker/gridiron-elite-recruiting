  ...
  return (
    <div className="flex flex-col -mx-4 -my-6 lg:-mx-8 lg:-my-8 h-[calc(100vh-4rem)] overflow-hidden">
      ...
      <div className="shrink-0 border-b border-border bg-card px-4 pb-4 pt-6 lg:px-8 lg:pt-8">
        {/* Desktop: side-by-side, buttons right-aligned (original layout) */}
        <div className="hidden sm:flex sm:items-end sm:justify-between sm:gap-4">
          <div>
            <h1 className="font-display text-3xl font-bold uppercase tracking-tight text-foreground">Email</h1>
        ...
        {/* Mobile: stacked, buttons wrap below (mobile optimization) */}
        <div className="sm:hidden">
          <h1 className="font-display text-2xl font-bold uppercase tracking-tight text-foreground">Email</h1>
          <p className="mt-1 flex items-center gap-1.5 text-sm text-muted-foreground">
            <Mail className="h-3.5 w-3.5 text-accent" />
            FOLLOW UP. BUILD RELATIONSHIPS.
          </p>
