          ...
          <Table>
            ...
            <TableBody>
              {filteredPrograms.map((program) => (
                <TableRow key={program.id} className="group cursor-pointer transition-colors hover:bg-primary/[0.03]">
                  <TableCell>
                    <div className="flex items-center gap-3">
          ...
          <Table>
            ...
            <TableBody>
              {filteredCoaches.map((coach) => {
                ...
                return (
                  <TableRow key={coach.id} className="group transition-colors hover:bg-primary/[0.03]">
                    <TableCell>
                    ...
                    <TableCell>
                      {coach.twitter_handle ? (
                        <div className="flex items-center gap-1">
                          <a
                            href={`https://twitter.com/${coach.twitter_handle}`}
                            target="_blank"
